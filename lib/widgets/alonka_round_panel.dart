                                    ...
                                    if (res != null) {
                                      switch (res) {
                                        case AlonkaCreditTypes.Alonka:
                                          setState(() {
                                            widget.round.alonkaCredits.add(
                                                widget.round
                                        ...
                                        case AlonkaCreditTypes.Gerikan:
                                          setState(() {
                                            widget.round.gerikanCredits.add(
                                                widget.round
                                                    .activeParticipants[index]);
                                            widget.round.activeParticipants
                                                .removeAt(index);
                                        ...
                                        case AlonkaCreditTypes.Runner:
                                          setState(() {
                                            widget.round.runCredits.add(widget
                                                .round
                                                .activeParticipants[index]);
                                            widget.round.activeParticipants
                                                .removeAt(index);
                                            ...
                                            return GestureDetector(
                                              onLongPress: () =>
                                                  setState(() {
                                                    ...
                                                    widget.round.activeParticipants.add(number);
                                ...
                                Row(
                                    children: List.generate(1, (index) {
                                      return Padding(
                                        padding: const EdgeInsets.all(1.0),
                                        child: Row(
                                          children: widget.round.gerikanCredits
                                              .map((number) {
                                            return GestureDetector(
                                              onLongPress: () =>
                                                  setState(() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      eventController.currentEvent.value.finalized?SizedBox.shrink():IconButton(
                          onPressed: () {
