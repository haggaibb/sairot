...
class _PerformancePageState extends State<PerformancePage> {
  ...
  int? _getNextParticipantNumber(int currentNumber) {
    List<Participant> activeParticipants =
        eventController.getSortedActiveParticipants();
    if (activeParticipants.isEmpty) return null;

    int currentIndex =
        activeParticipants.indexWhere((p) => p.number == currentNumber);
    if (currentIndex == -1 || currentIndex >= activeParticipants.length - 1)
      return null;
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      } else if (_finalGradeController.text.isNotEmpty &&
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (_commentsSummary != null &&
                                      _commentsSummary !=
                                          "אין הערות זמינות לסיכום." &&
                                      _commentsSummary !=
                                          "שגיאה ביצירת סיכום הערות." &&
                                      !_isGeneratingCommentsSummary)
                                    IconButton(
                            ...
                            children: [
                              ...
                              Directionality(
                                ...
                                child: Wrap(
                                  ...
                                  children: p.genericInstructorComments
                                      .map((comment) {
                                    return Chip(
                                      label: Text(
                                        comment,
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            eventController.saveParticipantsAIReport(
                                p.number, p.participantAIReport);
