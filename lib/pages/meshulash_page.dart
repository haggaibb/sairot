                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: () {
                                    ...
                                    final allRounds = List.from(eventController.currentEvent.value.meshulashRounds);
                                        ...
                                        return [
                                          Padding(
                                            ...
                                            child: Obx(() => eventController.loading.value
                                                ...
                                                : MeshulashRoundPanel(
                                                      key: ValueKey('meshulash_round_${allRounds[0].round}_$inOrderOfArrival'),
                                                      round: allRounds[0],
                                                      inOrderOfArrival: inOrderOfArrival,
                                                  )),
                                          )
                                    ...
                                    print('🔍 Meshulash: Showing rounds ${allRounds[firstRoundWithParticipants].round} to ${allRounds[lastRoundWithParticipants].round} (${roundsToShow.length} rounds)');
                                    return roundsToShow.map((round) {
                                      return Padding(
                                        ...
                                        child: Obx(() => eventController.loading.value
                                            ? CircularProgressIndicator()
                                            : MeshulashRoundPanel(
                                                  key: ValueKey('meshulash_round_${round.round}_$inOrderOfArrival'),
                                                  round: round,
                                                  inOrderOfArrival: inOrderOfArrival,
                                              )),
                                      );
