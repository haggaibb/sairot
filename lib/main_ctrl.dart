...
class MainController extends GetxController {
  ...
  /// 
  /// 
  Future<void> createNewInstructorEvent(Event event) async {
    try {
        await firestore.collection('/Events/${event.eventName}/days/${event.date}/exams').doc(event.instructorId).set();
    } catch (e) {
      print('Error creating event day: $e');
    }
